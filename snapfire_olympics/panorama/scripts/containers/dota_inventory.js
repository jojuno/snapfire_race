...
function CreateInventoryPanels() {
  ...
  if (!stashPanel || !firstRowPanel || !secondRowPanel) return;
  ...
  for (var i = 0; i < DOTA_ITEM_STASH_MAX; ++i) {
    ...
    inventoryPanel.BLoadLayout(
      "file://{resources}/layout/custom_game/containers/dota_inventory_item.xml",
      false,
      false
    );
...
(function () {
  ...
  GameEvents.Subscribe(
    "m_event_dota_inventory_changed_query_unit",
    UpdateInventory
  );
